...
const EXAMPLE_SCENARIO = {
  ...
  insiderInfo:
    "El técnico de Deportivo Mercado de Capitales suspendió a tres titulares por indisciplina la noche anterior. Alternativas FC llega descansado y con plantel completo.",
  correctAnswer: "YES"
};
